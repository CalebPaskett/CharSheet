  ...
  return (
    <details>
      ...
      <details>
        ...
        <div>Primary: <input type="number" value={props.values.extra.primary} onChange={(e) => props.setSubChar(props.char, "extra", "primary", e.target.value)}/></div>
        {(typeof props.values.primary_roll !== 'undefined') && <div>Primary Roll: <input value={props.values.extra.primary_roll} onChange={(e) => props.setSubChar(props.char, "extra", "primary_roll", e.target.value)}/></div>}
        {(typeof props.values.primary_noncombat !== 'undefined') && <div>Primary Noncombat: <input value={props.values.extra.primary_noncombat} onChange={(e) => props.setSubChar(props.char, "extra", "primary_noncombat", e.target.value)}/></div>}
        <div>Secondary: <input type="number" value={props.values.extra.secondary} onChange={(e) => props.setSubChar(props.char, "extra", "secondary", e.target.value)}/></div>
        {(typeof props.values.secondary_roll !== 'undefined') && <div>Secondary Roll: <input value={props.values.extra.secondary_roll} onChange={(e) => props.setSubChar(props.char, "extra", "secondary_roll", e.target.value)}/></div>}
        {(typeof props.values.secondary_noncombat !== 'undefined') && <div>Secondary Noncombat: <input value={props.values.extra.secondary_noncombat} onChange={(e) => props.setSubChar(props.char, "extra", "secondary_noncombat", e.target.value)}/></div>}
        <div>Increase: <input type="number" value={props.values.extra.increase} onChange={(e) => props.setSubChar(props.char, "extra", "increase", e.target.value)}/></div>
      </details>
    </details>
  )
}