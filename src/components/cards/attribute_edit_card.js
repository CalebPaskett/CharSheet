...
export const AttributeEditCard = (props) => {
  return (<div>
    ...
    {(props.attributeType === "powers") &&                                     <><input type="checkbox" id="is_ec"              checked={props.attribute.types.includes("ec")}              onChange={(e) => props.setAttribute([...props.parentPath, "types", "ec"], "toggle")}/>             <label htmlFor="is_ec">Elemental Control Power</label><br/></>}
